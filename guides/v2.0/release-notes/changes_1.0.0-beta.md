...
<h2 id="changes-contents">項目</h2>

*	<a href="#1.0.0-beta-changes">Merchant Betaリリースでのメジャーな変更点</a>
*	<a href="#1.0.0-beta-incompat">後方互換不可な変更点</a>
*	<a href="1.0.0-beta-feedback">フィードバックのお願い</a>
...
<div class="bs-callout bs-callout-warning">
    ...
    <p>このリリースでのデータベース変更のため,  Magentoソフトウェアのアンインストールは<em>必須</em>で再インストールしなければなりません。詳細は <a href="#1.0.0-beta-changes-schema">Module version changes (requires reinstallation)</a>にあります。</p>
</div>

<h2 id="1.0.0-beta-changes">Merchant Betaリリースでのメジャーな変更点</h2>
以下の変更を今回のリリースでおこないました:
